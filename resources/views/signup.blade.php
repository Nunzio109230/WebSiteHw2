<html>
    ...
    <body>
        ...
        <div class="signup">
                ...
                <a id="link_x" href="{{ url('login')}}"><img src="{{ url ('/img/x.png')}}" id="x"></a>
                <form name="registration_form" class="iscrizione" method="post">
                    ...
                    <img class="warn_confirm_passOff" src="{{ url ('/img/warning.png')}}">
